...
namespace Do_An_Tot_Nghiep
{
    public partial class doi_ten : Form
    {
        ...
        {
            string jsonString = File.ReadAllText(@"E:\Code_App\Do_An_Tot_Nghiep_App\Do_An_Tot_Nghiep\File\key_name.json");
            ...
            File.WriteAllText(@"E:\Code_App\Do_An_Tot_Nghiep_App\Do_An_Tot_Nghiep\File\key_name.json", updatedJsonString);
            File.Exists(@"E:\Code_App\Do_An_Tot_Nghiep_App\Do_An_Tot_Nghiep\File\key_name.json");
        }
        ...
        {
            StreamReader r = new StreamReader(@"E:\Code_App\Do_An_Tot_Nghiep_App\Do_An_Tot_Nghiep\File\key_name.json");
